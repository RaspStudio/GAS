...
class ShortcutList {
public:
    ShortcutList(size_t max_elements) : data_(max_elements) {}
...
public:
    ...
    RefShortcutList(size_t max_elements) : data_(max_elements) {}
...
public:
    ...
    explicit RefMutualShortcutList(size_t max_elements)
        : data_(max_elements) {}
