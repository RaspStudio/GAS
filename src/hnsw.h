...
// Global constants
constexpr size_t DEFAULT_STATUS_LIST_POOL_SIZE = 256;
...
public:
    ...
    ShortcutStorage<dist_t> shortcut_storage_;
    ...
    HierarchicalNSW(
        ...
        shortcut_storage_(max_elements, max_additional_edges_per_node, max_shortcuts_per_node),
